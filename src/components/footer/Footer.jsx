...
const Footer = () => {
  return (
    <div className=" grid lg:grid-cols-2 gap-20 lg:gap-20  py-14 lg:py-20 justify-around text-[#000000] font-Inter">
      ...
      <div className="flex flex-col md:flex-row gap-20 lg:gap-0 justify-between">
        <div>
